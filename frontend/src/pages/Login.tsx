    ...
    return (
        <div className="max-w-md mx-auto mt-10 p-8 bg-white border border-gray-100 rounded-sm shadow-sm font-sans">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button type="submit" className="w-full font-bold py-3 rounded-sm transition active:scale-95" style={{ backgroundColor: '#FFBA34', color: '#1A3620' }}>Se connecter</button>
            </form>
