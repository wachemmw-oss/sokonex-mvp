    ...
    return (
        <div className="max-w-md mx-auto mt-10 p-8 bg-white border border-gray-100 rounded-sm shadow-sm font-sans">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button type="submit" className="w-full bg-black text-white font-bold py-3 rounded-sm hover:bg-gray-800 transition active:scale-95">S'inscrire</button>
            </form>
            <p className="mt-6 text-center text-sm text-gray-600">
                Déjà un compte ? <Link to="/login" className="text-black font-bold underline hover:text-gray-700">Se connecter</Link>
            </p>
        </div>
    );
};
