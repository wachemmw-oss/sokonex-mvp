...
const AdminLayout: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-[#FAFAF8] flex flex-col md:flex-row font-sans">
            {/* Sidebar dark navy */}
            <aside className="w-full md:w-72 bg-gradient-to-b from-[#1a1a2e] to-[#0f3460] text-white flex flex-col shrink-0 shadow-2xl relative z-20 overflow-hidden">
                {/* Decorative background orb */}
                <div className="absolute -top-24 -left-24 w-64 h-64 bg-[var(--color-primary)]/10 rounded-full blur-3xl"></div>
                ...
                <div className="p-8 pb-6 relative z-10">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="font-black text-2xl tracking-tighter">SOKONEX <span className="text-[var(--color-primary)]">AD</span></span>
                    </div>
                ...
                <nav className="flex-1 px-4 py-8 space-y-1 relative z-10 overflow-y-auto scrollbar-hide">
                        ...
                        <NavLink
                            ...
                            className={({ isActive }) =>
                                `flex items-center justify-between group px-4 py-3.5 rounded-2xl transition-all duration-300 ${isActive
                                    ? 'bg-[var(--color-primary)]/20 text-[var(--color-primary)] shadow-inner'
                    ...
                    <div className="space-y-1">
                        <NavLink
                            to="/admin/reports"
                            className={({ isActive }) => `flex items-center justify-between group px-4 py-3.5 rounded-2xl transition-all duration-300 ${isActive ? 'bg-[var(--color-primary)]/20 text-[var(--color-primary)]' : 'text-white/60 hover:bg-white/5 hover:text-white'}`}
                        >
                            <div className="flex items-center gap-3">
                    ...
                    <NavLink
                        to="/admin/settings"
                        className={({ isActive }) => `flex items-center gap-3 group px-4 py-3.5 rounded-2xl transition-all duration-300 ${isActive ? 'bg-[var(--color-primary)]/20 text-[var(--color-primary)]' : 'text-white/60 hover:bg-white/5 hover:text-white'}`}
                    >
                ...
                <div className="p-4 relative z-10 border-t border-white/5 bg-black/10 backdrop-blur-sm">
                    {user && (
                        <div className="flex items-center gap-3 p-3 bg-white/5 rounded-2xl border border-white/5 mb-3">
                            <div className="w-10 h-10 rounded-xl bg-[var(--color-primary)] flex items-center justify-center text-white font-black text-sm shadow-lg overflow-hidden shrink-0">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-[10px] text-[var(--color-primary)] font-black uppercase tracking-widest leading-none mt-1">Administrateur</p>
                            </div>
                    ...
                    <NavLink
                        to="/"
                        className="flex items-center justify-center gap-2 py-3 w-full rounded-2xl bg-[var(--color-primary)] text-white font-black text-xs uppercase tracking-widest hover:bg-[#B71C1C] active:scale-95 transition-all shadow-lg"
                    >
